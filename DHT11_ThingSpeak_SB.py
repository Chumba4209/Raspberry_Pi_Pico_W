...
def start_config_portal():
    ...
    ap.active(True)
    ap.config(essid="ESP_DHT_Config", password="12345678")

    print("AP started → connect to WiFi 'ESP_DHT_Config', open http://192.168.4.1")
    ...
    while True:
        ...
        if "GET /?ssid=" in request:
            ...
            html = """<!DOCTYPE html>
<html>
  <head><title>DHT WiFi Setup</title></head>
  <body>
